...
graph TD;
    ...
    b1[Bastion Setup]-->c0[Bellman Provision];
    b1[Bastion Setup]-->d0[Seer Provision];
    b1[Bastion Setup]-->e0[Keeper Provision];
    b1[Bastion Setup]-->f0[Builder Provision];
    ...
    subgraph MagicMirror2
    c0-->c1[Bellman Setup];
    end
    
    subgraph Ollama/Open-WebUI
    d0-->d1[Seer Setup];
    end
    
    subgraph Image/Container Builder
    f0-->f1[Builder Setup];
    end
